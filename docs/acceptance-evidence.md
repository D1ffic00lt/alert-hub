...
For the current implementation, the latest local backend run completed **473 tests**
with **86.90% branch coverage** against a **75% CI floor**; Ruff, strict mypy, migrations, and the
...
| Area                                | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Level                  |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| Backend behavior                    | Ruff, strict mypy, a 473-test pytest suite with 86.90% measured branch coverage and a 75% gate, clean/previous-schema migration exercise, and generated OpenAPI contract comparison                                                                                                                                                                                                                                                                                                                                                            | Automated              |
| Ingest and incident projection      | API integration tests cover Alertmanager, generic JSON, recovery-only filtering, deduplication, out-of-order events, state actions, and restart-safe persistence. A pinned Alertmanager 0.32.1 container regression exercises child delivery, later aggregate inhibition, suppression of the primary recovery, and closure through the uninhibited recovery shadow. A separate three-database regression covers replicated heartbeat observations, false-miss prevention, and both recovery-before-firing and firing-before-recovery ordering. | Automated              |
