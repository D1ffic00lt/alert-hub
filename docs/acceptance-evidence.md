...
For the current implementation, the latest local backend run completed **221 tests**
with **82.28% branch coverage** against a **75% CI floor**; Ruff, strict mypy, migrations, and the
...
| Area                                | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Level                  |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| Backend behavior                    | Ruff, strict mypy, a 221-test pytest suite with 82.28% measured branch coverage and a 75% gate, clean/previous-schema migration exercise, and generated OpenAPI contract comparison                                                                                                                                                                                                                                                                                                                              | Automated              |
